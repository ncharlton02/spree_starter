...
ActiveRecord::Schema[7.1].define(version: 2024_05_23_142511) do
  ...
  create_table "spree_data_feeds", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "store_id"
    t.string "name"
    t.string "type"
    t.string "slug"
  ...
  create_table "spree_option_type_translations", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "spree_option_value_translations", charset: "utf8mb3", force: :cascade do |t|
    t.string "presentation"
    t.string "locale", null: false
  ...
  create_table "spree_payment_sources", charset: "utf8mb3", force: :cascade do |t|
    t.string "gateway_payment_profile_id"
    t.string "type"
    t.bigint "payment_method_id"
    t.bigint "user_id"
  ...
  create_table "spree_product_property_translations", charset: "utf8mb3", force: :cascade do |t|
    t.string "value"
    t.string "locale", null: false
  ...
  create_table "spree_product_translations", charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.string "locale", null: false
  ...
  create_table "spree_property_translations", charset: "utf8mb3", force: :cascade do |t|
    t.string "presentation"
    t.string "locale", null: false
  ...
  create_table "spree_stock_items", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.index ["variant_id", "stock_location_id"], name: "index_spree_stock_items_unique_without_deleted_at", unique: true
  ...
  create_table "spree_store_translations", charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.text "meta_description"
  ...
  create_table "spree_taxon_translations", charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.string "locale", null: false
  ...
  create_table "spree_taxonomy_translations", charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.string "locale", null: false
